...
import com.is.tngou.entity.DummyContent;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(GalleryDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(GalleryDetailFragment.ARG_ITEM_ID, holder.mItem.id);
